...
b7 = ggplot(Summary.Publisher.Units, aes(x = Publisher,
      ...
      scale_y_sqrt(breaks = c(5, 50, round(seq(0, 2000, length.out = 15), digits = 0)))
b7
...
genre on each platform. Blue squares are lower numbers published, while 
green squares are higher numbers of games.
...
published by each console company. The method for smoothing used is 'gam', 
since this is a larger dataset.
...
measure any years that are not complete in these numbers. 
